const WebsiteShowcaseRC = () => {
    return ( <div className="containerWebSCRC">
        ...
        <div className="innerDivWebSCRC">
            <img id="WebSCRC_1" className="WebSCRC" alt="web showcase img" src="./imgs/animation_menu/2.png" draggable="false"/>
            <img id="WebSCRC_2" className="WebSCRC" alt="web showcase img" src="./imgs/animation_menu/3.png" draggable="false"/>
...
export default WebsiteShowcaseRC;